...
<<<<<<< HEAD
            <img src="{{ (auth()->user()->photo)? Storage::url(auth()->user()->photo) : Avatar::create(auth()->user()->name)->toBase64() }}" class="user-image" alt="User Image">
=======
...
>>>>>>> afd76cba04b8009eec668905723f553914bf8168
